...
public:
  ...
  // Special copy and paste behaviour
  bool canInsertFromMimeData( const QMimeData *source ) const;
  void insertFromMimeData(const QMimeData *source);
  // XXX Carlo, set the methods that can't be visible to the completition, avoid problems
  void setInvisibleCompletitionMethods(const QStringList &invisible);
public slots:
  ...
  void appendWelcomeMessage(const QString &prefixMessage="");
...
private:
  ...
  QStringList invisibleCompletitionMethods;
